...
namespace hillvallea
{
  ...
  public: 
    ...
    // C++ Rule of Three
    //-------------------------------------------
    amalgam_t(const size_t number_of_parameters, const vec_t & lower_param_bounds, const vec_t & upper_param_bounds, double init_univariate_bandwidth, fitness_pt fitness_function, rng_pt rng, bool enable_multiplier_vec);
    ~amalgam_t();
    ...
    vec_t getSDR_vec(const solution_t & best, const vec_t & mean, matrix_t & cholesky_factor) const;
    ...
    void update_distribution_multiplier_vec(vec_t & multiplier, const bool improvement, int & no_improvement_stretch, const vec_t & sample_success_ratio, const vec_t & sdr) const;
